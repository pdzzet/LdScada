...
/* fwlib32.cs                                                        */
/*                                                                   */
/* CNC/PMC Data Window Library for FAnucComm/Ethernet                   */
/*                                                                   */
...
namespace KHBC.LD.FCCM.DeviceApi
{
    ...
    public static extern short cnc_rddynamic(ushort FlibHndl,
        ...
        public static extern short cnc_rdspmeter(ushort FlibHndl,
            short a, ref short b, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBSPDLName c);
    ...
    public static extern short cnc_rdprogdir2( ushort FlibHndl,
        ...
        /* get option state for FAnucComm/Ethernet */
        [DllImport("FWLIB32.dll", EntryPoint = "cnc_getFAnucCommopt")]
        public static extern short cnc_getFAnucCommopt(ushort FlibHndl, short a, out int b);
